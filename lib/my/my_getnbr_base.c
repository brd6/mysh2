/*
** my_getnbr_base.c for my_getnbr_base in /home/bongol_b/rendu/Piscine_C_J06
**
** Made by berdrigue bongolo-beto
** Login   <bongol_b@epitech.net>
**
** Started on  Tue Oct  6 11:22:12 2015 berdrigue bongolo-beto
** Last update Wed Feb 10 13:44:41 2016 Berdrigue BONGOLO BETO
*/
...
int	my_getnbr_base(char *str, char *base)
{
  ...
  if (!my_check_base(base) || !my_strlen(str))
    return (0);
  while (str[nbr_pos])
    {
