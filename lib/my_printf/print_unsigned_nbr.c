...
** Last update Thu Jan  7 23:39:45 2016 Berdrigue BONGOLO BETO
*/
...
{
  if (my_get_char_pos_x(ptf_format->flags, '0') != -1 &&
      my_get_char_pos_x(ptf_format->flags, '-') == -1)
    {
      *len_precision = *width;
      *width = 0;
    }
